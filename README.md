...
```javascript
import FLOAT64_MAX_NTH_DOUBLE_FACTORIAL from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-max-nth-double-factorial@v0.1.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/constants-float64-max-nth-double-factorial/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/constants-float64-max-nth-double-factorial/actions/workflows/test.yml?query=branch:v0.1.0
